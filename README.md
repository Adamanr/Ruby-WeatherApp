Приложение для получения информации о погоде по всему миру. Разработанное на Ruby с использованием фреймворка Rails с использованием гема 'open-weather-ruby-client'
